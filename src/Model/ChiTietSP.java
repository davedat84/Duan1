...
public class ChiTietSP {
    ...
    public ChiTietSP(String id, String idSP, String idNSX, String idMauSac, String idDongSP, Integer namBH, String moTa, Integer soLuongTon, Double giaNhap, Double giaBan) {
        this.id = id;
        this.idSP = idSP;
        this.idNSX = idNSX;
